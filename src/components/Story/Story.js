...
const Story = () => {
  return (
    <div className="story-info">
      ...
      <ul>
        <li>
          I served as Project Leader for this project and was responsible for planning the sprints based on previous velocity and project planning in
          the form of research and UML documents
        </li>
